...
namespace Chapter.Net.WPF.Controls
{
    ...
    public class ChapterTextBox : TextBox
    {
        ...
        protected override void OnLostFocus(RoutedEventArgs e)
        {
            ...
            if (TextModificator != null && TextModificator.ModificationTime == ModificationTime.OnLostFocus)
        ...
        protected override void OnTextChanged(TextChangedEventArgs e)
        {
            ...
            if (TextModificator != null && TextModificator.ModificationTime == ModificationTime.OnType)
            {
