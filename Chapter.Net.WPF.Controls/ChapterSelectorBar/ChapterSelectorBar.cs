// -----------------------------------------------------------------------------------------------------------------
// <copyright file="ChapterSelectorBar.cs" company="my-libraries">
...
namespace Chapter.Net.WPF.Controls
{
    ...
    public class ChapterSelectorBar : ListBoxBase
    {
        ...
        /// </summary>
        public static readonly ComponentResourceKey StyleKey = new ComponentResourceKey(typeof(ChapterSelectorBar), "ChapterSelectorBar");
