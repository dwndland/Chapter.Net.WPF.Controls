// -----------------------------------------------------------------------------------------------------------------
// <copyright file="ChapterCheckBox.cs" company="my-libraries">
...
namespace Chapter.Net.WPF.Controls
{
    ...
    public class ChapterCheckBox : CheckBoxBase
    {
        ...
        /// </summary>
        public static readonly ComponentResourceKey StyleKey = new ComponentResourceKey(typeof(ChapterCheckBox), "ChapterCheckBox");
