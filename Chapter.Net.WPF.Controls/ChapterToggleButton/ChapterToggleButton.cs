// -----------------------------------------------------------------------------------------------------------------
// <copyright file="ChapterToggleButton.cs" company="my-libraries">
...
namespace Chapter.Net.WPF.Controls
{
    ...
    public class ChapterToggleButton : ToggleButtonBase
    {
        ...
        /// </summary>
        public static readonly ComponentResourceKey StyleKey = new ComponentResourceKey(typeof(ChapterToggleButton), "ChapterToggleButton");
