// -----------------------------------------------------------------------------------------------------------------
// <copyright file="ChapterNavigationViewItem.cs" company="dwndland">
...
public class ChapterNavigationViewItem : ChapterTreeViewItem
{
    ...
    /// </summary>
    public static readonly ComponentResourceKey StyleKey = new(typeof(ChapterNavigationViewItem), "ChapterNavigationViewItem");
