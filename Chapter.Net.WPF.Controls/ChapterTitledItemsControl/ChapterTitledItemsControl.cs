// -----------------------------------------------------------------------------------------------------------------
// <copyright file="ChapterTitledItemsControl.cs" company="dwndland">
...
public class ChapterTitledItemsControl : ItemsControlBase
{
    ...
    /// </summary>
    public static readonly ComponentResourceKey StyleKey = new(typeof(ChapterTitledItemsControl), "ChapterTitledItemsControl");
