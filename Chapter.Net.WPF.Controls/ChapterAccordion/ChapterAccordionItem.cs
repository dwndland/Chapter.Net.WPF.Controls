// -----------------------------------------------------------------------------------------------------------------
// <copyright file="ChapterAccordionItem.cs" company="my-libraries">
...
namespace Chapter.Net.WPF.Controls
{
    ...
    public class ChapterAccordionItem : ExpanderBase
    {
        ...
        /// </summary>
        public static readonly ComponentResourceKey StyleKey = new ComponentResourceKey(typeof(ChapterAccordionItem), "ChapterAccordionItem");
